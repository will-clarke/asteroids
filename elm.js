...
var _user$project$Vector$add = F2(
	function (a, b) {
		...
		var ax = _p1._0;
		var ay = _p1._1;
		return {ctor: '_Tuple2', _0: ax + bx, _1: ay + by};
	});
var _user$project$Vector$multScalar = F2(
	function (vector, constant) {
		var _p2 = vector;
		var x = _p2._0;
		var y = _p2._1;
		return {ctor: '_Tuple2', _0: x * constant, _1: y * constant};
	});
...
var _user$project$Vector$unitYRotated = function (degrees) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$negate(
			_elm_lang$core$Basics$sin(degrees)),
		_1: _elm_lang$core$Basics$cos(degrees)
	};
};
var _user$project$Vector$unitXRotated = function (degrees) {
	return {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$cos(degrees),
		_1: _elm_lang$core$Basics$sin(degrees)
	};
};
var _user$project$Vector$rotateUnitCircle = function (degrees) {
	return A2(
		_user$project$Vector$add,
		_user$project$Vector$unitXRotated(degrees),
		_user$project$Vector$unitYRotated(degrees));
};
var _user$project$Vector$rotate = F2(
	function (vec, angle) {
		var _p5 = vec;
		var x = _p5._0;
		var y = _p5._1;
...
var _user$project$Ship$shipCoords = function (ship) {
	return {
		ctor: '::',
		_0: A2(
			_user$project$Vector$add,
...
var _user$project$Ship$shipVelocity = 90.0;
var _user$project$Ship$Ship = F3(
	function (a, b, c) {
		return {position: a, velocity: b, angle: c};
	});
var _user$project$Ship$setPosition = F2(
	function (_p0, ship) {
		var _p1 = _p0;
		return A3(
			_user$project$Ship$Ship,
			{ctor: '_Tuple2', _0: _p1._0, _1: _p1._1},
			ship.velocity,
			ship.angle);
	});
var _user$project$Ship$setVelocity = F2(
	function (_p2, ship) {
		var _p3 = _p2;
		return A3(
			_user$project$Ship$Ship,
...
var _user$project$Ship$addRelativePosition = F2(
	function (_p4, ship) {
		var _p5 = _p4;
		var _p6 = ship.position;
		var shipX = _p6._0;
		var shipY = _p6._1;
		return A3(
			_user$project$Ship$Ship,
			{ctor: '_Tuple2', _0: shipX + _p5._0, _1: shipY + _p5._1},
			ship.velocity,
			ship.angle);
	});
var _user$project$Ship$addRelativeVelocity = F2(
	function (_p7, ship) {
		var _p8 = _p7;
		var _p9 = ship.velocity;
		var velX = _p9._0;
		var velY = _p9._1;
		return A3(
			_user$project$Ship$Ship,
			ship.position,
			{ctor: '_Tuple2', _0: velX + _p8._0, _1: velY + _p8._1},
			ship.angle);
	});
var _user$project$Ship$addRelativeAngle = F2(
	function (angle, ship) {
		return A3(_user$project$Ship$Ship, ship.position, ship.velocity, ship.angle + angle);
	});
var _user$project$Ship$reduceVelocity = F2(
	function (n, ship) {
		var _p10 = ship.velocity;
		var x = _p10._0;
		var y = _p10._1;
		var newX = (_elm_lang$core$Native_Utils.cmp(x, n) > 0) ? (x - n) : ((_elm_lang$core$Native_Utils.cmp(x, 0 - n) < 0) ? (x + n) : 0);
		var newY = (_elm_lang$core$Native_Utils.cmp(y, n) > 0) ? (y - n) : ((_elm_lang$core$Native_Utils.cmp(y, 0 - n) < 0) ? (y + n) : 0);
		return A3(
			_user$project$Ship$Ship,
			ship.position,
...
var _user$project$Bullet$Bullet = F2(
	function (a, b) {
		return {position: a, velocity: b};
	});
var _user$project$Bullet$fire = F2(
	function (ship, bullets) {
		var newBullet = A2(_user$project$Bullet$Bullet, ship.position, ship.velocity);
		return {ctor: '::', _0: newBullet, _1: bullets};
	});

var _user$project$Key$Unknown = {ctor: 'Unknown'};
var _user$project$Key$Q = {ctor: 'Q'};
var _user$project$Key$Meta = {ctor: 'Meta'};
var _user$project$Key$Control = {ctor: 'Control'};
var _user$project$Key$Down = {ctor: 'Down'};
var _user$project$Key$Up = {ctor: 'Up'};
var _user$project$Key$Right = {ctor: 'Right'};
var _user$project$Key$Left = {ctor: 'Left'};
var _user$project$Key$Space = {ctor: 'Space'};
var _user$project$Key$fromCode = function (keyCode) {
	var _p0 = keyCode;
	switch (_p0) {
		case 81:
			return _user$project$Key$Q;
		case 32:
			return _user$project$Key$Space;
		case 37:
			return _user$project$Key$Left;
		case 38:
			return _user$project$Key$Up;
		case 39:
			return _user$project$Key$Right;
		case 40:
			return _user$project$Key$Down;
		case 17:
			return _user$project$Key$Control;
		case 91:
			return _user$project$Key$Meta;
		default:
			return _user$project$Key$Unknown;
	}
};

var _user$project$Model$addRelativePositionToShip = F2(
	function (coordPair, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				ship: A2(_user$project$Ship$addRelativePosition, coordPair, model.ship)
			});
	});
var _user$project$Model$addRelativeAngleToShip = F2(
	function (angle, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				ship: A2(_user$project$Ship$addRelativeAngle, angle, model.ship)
			});
	});
var _user$project$Model$addRelativeVelocityToShip = F2(
	function (coordPair, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				ship: A2(_user$project$Ship$addRelativeVelocity, coordPair, model.ship)
			});
	});
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {ship: a, paused: b, windowSize: c, keysDown: d, bullets: e};
	});

var _user$project$Main$bulletToCollageForm = function (bullet) {
	return A2(
		...
		A2(
			...
			_evancz$elm_graphics$Collage$circle(21.0)));
};
var _user$project$Main$bulletCollages = function (bullets) {
	return A2(_elm_lang$core$List$map, _user$project$Main$bulletToCollageForm, bullets);
};
	...
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			_elm_lang$core$Basics$round(
				_elm_lang$core$Tuple$first(model.windowSize)),
			_elm_lang$core$Basics$round(
				_elm_lang$core$Tuple$second(model.windowSize)),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Main$bulletCollages(model.bullets),
				{
					ctor: '::',
					_0: _evancz$elm_graphics$Collage$text(
						_evancz$elm_graphics$Text$fromString(
							_elm_lang$core$Basics$toString(model.keysDown))),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$elm_graphics$Collage$filled,
							...
							_evancz$elm_graphics$Collage$polygon(
								_user$project$Ship$shipCoords(model.ship))),
						_1: {ctor: '[]'}
					}
				})));
};
var _user$project$Main$keyPressed = F2(
		...
		switch (_p0.ctor) {
			case 'Q':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						ship: A2(_user$project$Ship$reduceVelocity, 10.0, model.ship)
					});
			case 'Meta':
				return _elm_lang$core$Native_Utils.update(
					model,
			...
			case 'Space':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						bullets: A2(_user$project$Bullet$fire, ship, model.bullets)
					});
			case 'Up':
				return A2(
					_user$project$Model$addRelativeVelocityToShip,
					A2(
						_user$project$Vector$rotate,
			...
			case 'Down':
				return A2(
					...
					model);
			case 'Left':
				return A2(_user$project$Model$addRelativeAngleToShip, 0.1, model);
			case 'Right':
				return A2(_user$project$Model$addRelativeAngleToShip, -0.1, model);
			default:
				return model;
...
var _user$project$Main$keysPressed = function (model) {
	var foldlFunction = F2(
		function (keycode, model) {
			return A2(_user$project$Main$keyPressed, keycode, model);
		});
	return A3(_elm_lang$core$Set$foldl, foldlFunction, model, model.keysDown);
};
var _user$project$Main$updateBullet = F2(
	function (dt, bullet) {
		var newPosition = A2(_user$project$Vector$add, bullet.velocity, bullet.position);
		return _elm_lang$core$Native_Utils.update(
			bullet,
			{position: newPosition});
	});
var _user$project$Main$updateBullets = F2(
	function (dt, bullets) {
		var _p1 = bullets;
		if (_p1.ctor === '[]') {
			return bullets;
			...
			return {
				ctor: '::',
				_0: A2(_user$project$Main$updateBullet, dt, _p1._0),
				_1: A2(_user$project$Main$updateBullets, dt, _p1._1)
			};
		}
	});
var _user$project$Main$updateBulletsToModel = F2(
	function (dt, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				bullets: A2(_user$project$Main$updateBullets, dt, model.bullets)
			});
	});
var _user$project$Main$updateVelocity = F2(
	function (dt, model) {
		var ship = model.ship;
		var _p2 = ship.position;
		var posX = _p2._0;
		var posY = _p2._1;
		var _p3 = ship.velocity;
		var velX = _p3._0;
		var velY = _p3._1;
		var newPositionX = posX + ((velX * dt) / _user$project$Ship$shipVelocity);
		var newPositionY = posY + ((velY * dt) / _user$project$Ship$shipVelocity);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				ship: A3(
					_user$project$Ship$Ship,
					{ctor: '_Tuple2', _0: newPositionX, _1: newPositionY},
					ship.velocity,
					ship.angle)
			});
	});
var _user$project$Main$ensureWorldWrap = function (model) {
	var _p4 = model.windowSize;
	var windowX = _p4._0;
	var windowY = _p4._1;
	var _p5 = model.ship.position;
	var shipX = _p5._0;
	var shipY = _p5._1;
	return (_elm_lang$core$Native_Utils.cmp(shipX, windowX / 2) > 0) ? A2(
		_user$project$Model$addRelativePositionToShip,
		{
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$negate(windowX),
			_1: 0
		},
		model) : ((_elm_lang$core$Native_Utils.cmp(
		shipX,
		_elm_lang$core$Basics$negate(windowX) / 2) < 0) ? A2(
		_user$project$Model$addRelativePositionToShip,
		{ctor: '_Tuple2', _0: windowX, _1: 0},
		model) : ((_elm_lang$core$Native_Utils.cmp(shipY, windowY / 2) > 0) ? A2(
		_user$project$Model$addRelativePositionToShip,
		{
			ctor: '_Tuple2',
			_0: 0,
			_1: _elm_lang$core$Basics$negate(windowY)
		},
		model) : ((_elm_lang$core$Native_Utils.cmp(
		shipY,
		_elm_lang$core$Basics$negate(windowY) / 2) < 0) ? A2(
		_user$project$Model$addRelativePositionToShip,
		{ctor: '_Tuple2', _0: 0, _1: windowX},
		model) : model)));
};
var _user$project$Main$step = F2(
	function (dt, model) {
		var m = _user$project$Main$ensureWorldWrap(
			A2(
				_user$project$Main$updateBulletsToModel,
				dt,
				A2(_user$project$Main$updateVelocity, dt, model)));
	...
	function (msg, model) {
		...
		switch (_p6.ctor) {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							windowSize: {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Basics$toFloat(_p7.width),
								_1: _elm_lang$core$Basics$toFloat(_p7.height - 50)
							}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Main$keysPressed(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								keysDown: A2(_elm_lang$core$Set$insert, _p6._0, model.keysDown)
							})),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyUp':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							keysDown: A2(_elm_lang$core$Set$remove, _p6._0, model.keysDown)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(_user$project$Main$step, _p6._0, model);
		}
	});
...
var _user$project$Main$SetWindowSize = function (a) {
...
var _user$project$Main$init = {
	...
	_0: A5(
		...
		{ctor: '[]'}),
	_1: A2(_elm_lang$core$Task$perform, _user$project$Main$SetWindowSize, _elm_lang$window$Window$size)
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _elm_lang$window$Window$resizes(
				function (winSize) {
					return _user$project$Main$SetWindowSize(winSize);
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$PauseToggle = {ctor: 'PauseToggle'};
